...
function DataProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>{
            ...
            if (storedData) {
                console.log('📦 Loaded portfolioData from localStorage');
                setPortfolioData(JSON.parse(storedData));
            } else {
                console.log('🚀 Fetching portfolioData from API');
                loadFromAPI();
            }
        }
    }["DataProvider.useEffect"], []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16c81bb1._.js.map