...
// Validate ../../src/app/api/time-slots/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/time-slots">> = Specific
  const handler = {} as typeof import("../../src/app/api/time-slots/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
